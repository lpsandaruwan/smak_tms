...
<head>
	<meta charset="utf-8">
	<title>SMAK TMS add hired vehicle</title>
    ...
    <body>
		...
		<div id="container2">
				...
				<form class="form-horizontal" role="form" method="post">
					...
					<div class="form-group">
						<label for="ownid" class="col-sm-2 control-label">Owner ID</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="mod" name="ownid" placeholder="ex. TUO031" value=""><?php echo '<font color="red">'.form_error('ownid').'</font>'; ?>
						</div>
					</div>
					<div class="form-group">
						<label for="oname" class="col-sm-2 control-label">Owner name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="oname" name="oname" placeholder="owner name" value=""><?php echo '<font color="red">'.form_error('oname').'</font>'; ?>
						</div>
					</div>
					<div class="form-group">
						<label for="oaddress" class="col-sm-2 control-label">Owner Address</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="oaddress" name="oaddress" placeholder="Owner Address" value=""><?php echo '<font color="red">'.form_error('oaddress').'</font>'; ?>
						</div>
					</div>
					<div class="form-group">
						<label for="ophone" class="col-sm-2 control-label">Owner Phone</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="ophone" name="ophone" placeholder="011xxxxxxx" value=""><?php echo '<font color="red">'.form_error('ophone').'</font>'; ?>
						</div>
					</div>
					<div class="form-group">
						<label for="onic" class="col-sm-2 control-label">Owner NIC</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="onic" name="onic" placeholder="owner NIC" value=""><?php echo '<font color="red">'.form_error('onic').'</font>'; ?>
						</div>
					</div>
					<div class="form-group">
